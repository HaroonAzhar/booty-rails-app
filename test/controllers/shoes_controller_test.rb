...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post shoes_url, params: { shoe: { model: @shoe.model, style: @shoe.style, year: @shoe.year } }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { model: @shoe.model, style: @shoe.style, year: @shoe.year } }
