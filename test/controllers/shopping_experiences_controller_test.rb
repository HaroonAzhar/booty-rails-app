...
class ShoppingExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping_experience" do
    assert_difference('ShoppingExperience.count') do
      post shopping_experiences_url, params: { shopping_experience: { cart_id: @shopping_experience.cart_id, date: @shopping_experience.date, total: @shopping_experience.total } }
    end
  ...
  test "should update shopping_experience" do
    patch shopping_experience_url(@shopping_experience), params: { shopping_experience: { cart_id: @shopping_experience.cart_id, date: @shopping_experience.date, total: @shopping_experience.total } }
